...
\texttt{Bioconductor.sty} defines a shortcut \verb+\incfig{filename}{width}{shorttitle}{extendedcaption}+, which expects four arguments:
...
\incfig{LatexStyle-figureexample}{0.25\textwidth}{A curve.}{The code that creates this figure is shown in the code chunk.}
\parindent0mm\verb+\incfig{LatexStyle-figureexample}{0.25\textwidth}{A curve.}%+\\
