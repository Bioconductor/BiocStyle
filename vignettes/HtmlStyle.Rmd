...
## Authoring `r CRANpkg("rmarkdown")` / HTML package vignettes
...
rather than as an argument to `BiocStyle::markdown`. See [Use with the
`r CRANpkg("rmarkdown")` package](#rmarkdown) for details.

## Use with _[RStudio][]_

Currently, there are two markdown engines build into _RStudio_: the
