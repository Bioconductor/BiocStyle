...
inserted after this heading. Everything after the list of references will be considered as 
appendices. See below for an example of the formatting change.  
For more details on include a bibligraphy please see the relevant chapter of
