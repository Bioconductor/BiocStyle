...
%---------------------------------------------------------
\section{Additional features when using \Rpackage{knitr}}
%---------------------------------------------------------

To use \verb+\incfig+ to insert figures in \Rpackage{knitr}, use the
option \Rcode{fig.show='hide'} rather than \Rcode{include=FALSE}. The
