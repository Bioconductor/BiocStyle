...
BLAH BLAH \cite{Gentleman:2004}

BLAH BLAH \citet{Gentleman:2004}

BLAH BLAH \citep{Gentleman:2004}

\nocite{*}
% \bibliographystyle{/Users/khansen/Work/packages/BiocStyle/inst/sty/unsrturl}
\bibliography{Bioc}
