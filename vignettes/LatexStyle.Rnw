...
copiis exirent: perfacile esse, cum virtute omnibus praestarent,
...
belli atque fortitudinis angustos se fines habere arbitrabantur, qui
...
\Rcode{use.unsrturl=FALSE} and follow normal \LaTeX{} convetions.
